...
> twinder twinder ======= A simple application that showcases Fabric + Cocoapods and simple tweet swiping 1. Download Fabric.app via Fabric.io 2. Enable the TwitterKit by walking through the various steps. 3. Ensure that you have some keys and secrets in Fabric under your Info.plist
